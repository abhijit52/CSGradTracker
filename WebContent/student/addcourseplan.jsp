...
<script>
	...
	function addRow() {
		...
		//Course Comment
		var cellComment = row.insertCell(4);
		element = document.createElement('input');
		element.type = 'text';
		element.id = 'cmnt' + index;
		element.name = 'cmnt' + index;
		element.size = 30;
		cellComment.appendChild(element);
	...
	function validate()
	{
		...
		var comment = document.getElementById("user").value;
...
<body onload="showResult();">
	<form id="fromAddCoursePlan" method="post" action="addCoursePlan.do">
		<div class="size">
						...
						<div id="MainPlaceHolder">
							<div class="mc0201">
								...
								<table id="selectTable">
									...
									<tr>
										<td>
											<input type="button" value="Add this course to my plan" onclick="addRow();" />
										</td>
										<td>
											<input type="button" value="Remove the Last Course" onclick="removeRow();" />
										</td>
									</tr>
								</table>
