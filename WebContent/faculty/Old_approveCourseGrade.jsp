						...
						<div id="MainPlaceHolder">
							<div class="mc0201">
								...
								<table id="selectTable">
									...
									<tr>
										<td><input type="Submit" value="Submit" id="btnshow" name="btnshow" /></td>
									</tr>
								</table>
								...
								<table id="tableCourse" class="elementstable">
									<tr>
										<th align="left" class="elementslabel" style="max-width: 2px;"
									...
									%>
									<tr>
										<td class="elementslabelinfo" style="max-width: 2px;">
											<input type="checkbox" name="<%out.print("check" + i);%>" id="<%out.print("check" + i);%>" 
												value="<%out.print(i + "");%>">
										</td>
								...
								<table>
									<tr>
										<td><input type="Submit" value="Approve" id="btnsubmit" name="btnsubmit" /></td>
									</tr>
								</table>
							</div>
						</div>
