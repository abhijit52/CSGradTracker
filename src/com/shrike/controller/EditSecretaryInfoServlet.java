...
/**
 * Servlet implementation class EditSecretaryInfoServlet.
 */
@WebServlet("/EditSecretaryInfoServlet")
public class EditSecretaryInfoServlet extends HttpServlet {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;
       
    /**
     * Instantiates a new edits the secretary info servlet.
     *
     * @see HttpServlet#HttpServlet()
     */
    public EditSecretaryInfoServlet() {
        super();
        // TODO Auto-generated constructor stub
    }

	/**
	 * Do get method loads editing secretary dashboard information
	 *
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.isUserInRole("secretary"))
		{
			...
			if (userType.equalsIgnoreCase("secretary")) {
				nextPage = "/secretary/updateInfoSecretary.jsp";
	...
	/**
	 * Do post method saves the secretary information to the database 
	 *
	 * @param request the request
	 * @param response the response
	 * @throws ServletException the servlet exception
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/secretary/updateInfoSecretary.jsp");
